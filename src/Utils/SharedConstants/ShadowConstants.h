...
namespace SharedConstants {
    namespace ShadowConstants {
        static constexpr float VIEW_WIDTH = 150.0f;  // 빛이 비추는 가로 범위
        static constexpr float VIEW_HEIGHT = 150.0f;  // 빛이 비추는 세로 범위
        //static constexpr float VIEW_WIDTH = 40.0f;  // 빛이 비추는 가로 범위
        //static constexpr float VIEW_HEIGHT = 40.0f;  // 빛이 비추는 세로 범위
